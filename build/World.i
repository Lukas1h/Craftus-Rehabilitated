# 0 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c"
# 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c"
...
# 2 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c" 2

# 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/blocks/BlockEvents.h" 1
...
# 4 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c" 2



# 1 "/opt/devkitpro/devkitARM/arm-none-eabi/include/assert.h" 1 3
# 39 "/opt/devkitpro/devkitARM/arm-none-eabi/include/assert.h" 3
...
void __assert_func (const char *, int, const char *, const char *)
     __attribute__ ((__noreturn__));
# 8 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c" 2
...
# 9 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c" 2



# 11 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c"
void World_Init(World* world, WorkQueue* workqueue) {
 ...
 memset((&world->freeChunks), 0, sizeof(*(&world->freeChunks)));
...
void World_Reset(World* world) {
 ...
 ((&world->freeChunks)->length = 0);

 for (size_t i = 0; i < ((9) * (9) + (2 * (9) + (9) * (9))); i++) {
  world->chunkPool[i].x = 0x7fffffff;
  world->chunkPool[i].z = 0x7fffffff;
  ( vec_expand_((char**)&(&world->freeChunks)->data, &(&world->freeChunks)->length, &(&world->freeChunks)->capacity, sizeof(*(&world->freeChunks)->data)) ? -1 : ((&world->freeChunks)->data[(&world->freeChunks)->length++] = (&world->chunkPool[i]), 0), 0 );
 }
...
Chunk* World_LoadChunk(World* world, int x, int z) {
 for (int i = 0; i < world->freeChunks.length; i++) {
  if (world->freeChunks.data[i]->x == x && world->freeChunks.data[i]->z == z) {
   ...
   ( vec_splice_((char**)&(&world->freeChunks)->data, &(&world->freeChunks)->length, &(&world->freeChunks)->capacity, sizeof(*(&world->freeChunks)->data), i, 1), (&world->freeChunks)->length -= (1) );
 ...
 return 
# 63 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c" 3 4
       ((void *)0)
# 63 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c"
           ;
}
void World_UnloadChunk(World* world, Chunk* chunk) {
 WorkQueue_AddItem(world->workqueue, (WorkerItem){WorkerItemType_Save, chunk});
 ( vec_expand_((char**)&(&world->freeChunks)->data, &(&world->freeChunks)->length, &(&world->freeChunks)->capacity, sizeof(*(&world->freeChunks)->data)) ? -1 : ((&world->freeChunks)->data[(&world->freeChunks)->length++] = (chunk), 0), 0 );
 chunk->references--;
}
...
Chunk* World_GetChunk(World* world, int x, int z) {
 ...
 return 
# 78 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c" 3 4
       ((void *)0)
# 78 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c"
           ;
}

Block World_GetBlock(World* world, int x, int y, int z) {
 if (y < 0 || y >= (128)) return Block_Air;
...
# 103 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c"
void World_SetBlock(World* world, int x, int y, int z, Block block) {
 if (y < 0 || y >= (128)) return;
 ...
 if (chunk) {
  ...
  if (lX == 0) { Chunk* neightborChunk = World_GetChunk(world, cX + -1, cZ + 0); if (neightborChunk) Chunk_RequestGraphicsUpdate(neightborChunk, y / (16)); } if (lX == 15) { Chunk* neightborChunk = World_GetChunk(world, cX + 1, cZ + 0); if (neightborChunk) Chunk_RequestGraphicsUpdate(neightborChunk, y / (16)); } if (lZ == 0) { Chunk* neightborChunk = World_GetChunk(world, cX + 0, cZ + -1); if (neightborChunk) Chunk_RequestGraphicsUpdate(neightborChunk, y / (16)); } if (lZ == 15) { Chunk* neightborChunk = World_GetChunk(world, cX + 0, cZ + 1); if (neightborChunk) Chunk_RequestGraphicsUpdate(neightborChunk, y / (16)); } if (WorldToLocalCoord(y) == 0 && y / (16) - 1 >= 0) Chunk_RequestGraphicsUpdate(chunk, y / (16) - 1); if (WorldToLocalCoord(y) == 15 && y / (16) + 1 < ((128) / (16))) Chunk_RequestGraphicsUpdate(chunk, y / (16) + 1);
 }
}
...
void World_UpdateChunkCache(World* world, int orginX, int orginZ) {
 if (orginX != world->cacheTranslationX || orginZ != world->cacheTranslationZ) {
  ...
  int oldBufferStartX = world->cacheTranslationX - (9) / 2;
  int oldBufferStartZ = world->cacheTranslationZ - (9) / 2;
  ...
  for (int i = 0; i < (9); i++) {
   for (int j = 0; j < (9); j++) {
    int wx = orginX + (i - (9) / 2);
    int wz = orginZ + (j - (9) / 2);
    if (wx >= oldBufferStartX && wx < oldBufferStartX + (9) && wz >= oldBufferStartZ &&
        wz < oldBufferStartZ + (9)) {
     world->chunkCache[i][j] = tmpBuffer[i + diffX][j + diffZ];
     tmpBuffer[i + diffX][j + diffZ] = 
# 183 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c" 3 4
                                      ((void *)0)
# 183 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c"
                                          ;
    } else {
  ...
  for (int i = 0; i < (9); i++) {
   for (int j = 0; j < (9); j++) {
    if (tmpBuffer[i][j] != 
# 192 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c" 3 4
                          ((void *)0)
# 192 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c"
                              ) {
...
void World_Tick(World* world) {
 for (int x = 0; x < (9); x++)
  for (int z = 0; z < (9); z++) {
   ...
   if (x > 0 && z > 0 && x < (9) - 1 && z < (9) - 1 &&
       chunk->genProgress == ChunkGen_Terrain && !chunk->tasksRunning) {
    
# 213 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c" 3 4
   _Bool 
# 213 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c"
        clear = 
# 213 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c" 3 4
                1
# 213 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c"
    ...
    for (int xOff = -1; xOff < 2 && clear; xOff++)
     for (int zOff = -1; zOff < 2 && clear; zOff++) {
      ...
      if (borderChunk->genProgress == ChunkGen_Empty || !borderChunk->tasksRunning) clear = 
# 217 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c" 3 4
                                                                                           0
# 217 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/World.c"
                                                                                                ;
     }
