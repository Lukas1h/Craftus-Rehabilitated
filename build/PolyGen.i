# 0 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c"
# 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c"
...
# 6 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/world/WorkQueue.h" 2
...
# 4 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/rendering/PolyGen.h" 2
...
# 5 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/rendering/PolyGen.h" 2
...
# 6 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/rendering/PolyGen.h" 2
...
# 2 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c" 2
...
void DebugUI_Draw();
# 4 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c" 2
# 14 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c"
...
static struct { VBOUpdate *data; int length, capacity; } vboUpdates;
...
# 89 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c" 3 4
_Bool 
# 89 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c"
     transparent;
} Face;
...
static inline Block fastBlockFetch(World* world, Chunk* chunk, Cluster* cluster, int x, int y, int z) {
 return (x < 0 || y < 0 || z < 0 || x >= (16) || y >= (16) || z >= (16))
     ? World_GetBlock(world, (chunk->x * (16)) + x, (cluster->y * (16)) + y, (chunk->z * (16)) + z)
     : cluster->blocks[x][y][z];
}
static inline uint8_t fastMetadataFetch(World* world, Chunk* chunk, Cluster* cluster, int x, int y, int z) {
 return (x < 0 || y < 0 || z < 0 || x >= (16) || y >= (16) || z >= (16))
     ? World_GetMetadata(world, (chunk->x * (16)) + x, (cluster->y * (16)) + y, (chunk->z * (16)) + z)
...
static struct { QueueElement *data; int length, capacity; } floodfill_queue;
...
void PolyGen_Init(World* world_, Player* player_) {
 ...
 memset((&floodfill_queue), 0, sizeof(*(&floodfill_queue)));

 LightLock_Init(&updateLock);

 memset((&vboUpdates), 0, sizeof(*(&vboUpdates)));
}
void PolyGen_Deinit() {
 ( free((&vboUpdates)->data), memset((&vboUpdates), 0, sizeof(*(&vboUpdates))) );

 VBOCache_Deinit();

 ( free((&floodfill_queue)->data), memset((&floodfill_queue), 0, sizeof(*(&floodfill_queue))) );
}
  ...
  if (vboUpdates.length > 0) {
   if (vboUpdates.data[0].delay++ > 2)
    while (vboUpdates.length > 0) {
     VBOUpdate update = (&vboUpdates)->data[--(&vboUpdates)->length];
...
static Face faceBuffer[((16) * (16) * (16) / 2 * 6)];
static int currentFace;
static int transparentFaces;
static uint8_t floodfill_visited[(16)][(16)][(16)];

static inline void addFace(int x, int y, int z, Direction dir, Block block, uint8_t metadata, int ao, 
# 163 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c" 3 4
                                                                                                     _Bool 
# 163 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c"
                                                                                                          transparent) {
...
static uint16_t floodFill(World* world, Chunk* chunk, Cluster* cluster, int x, int y, int z, Direction entrySide0, Direction entrySide1,
 ...
 uint8_t exitPoints[6] = {
# 173 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c" 3 4
                         0
# 173 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c"
                              };
 if (entrySide0 != Direction_Invalid) exitPoints[entrySide0] = 
# 174 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c" 3 4
                                                              1
# 174 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c"
                                                                  ;
 if (entrySide1 != Direction_Invalid) exitPoints[entrySide1] = 
# 175 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c" 3 4
                                                              1
# 175 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c"
                                                                  ;
 if (entrySide2 != Direction_Invalid) exitPoints[entrySide2] = 
# 176 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c" 3 4
                                                              1
# 176 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c"
                                                                  ;
 ((&floodfill_queue)->length = 0);
 ( vec_expand_((char**)&(&floodfill_queue)->data, &(&floodfill_queue)->length, &(&floodfill_queue)->capacity, sizeof(*(&floodfill_queue)->data)) ? -1 : ((&floodfill_queue)->data[(&floodfill_queue)->length++] = (((QueueElement){x, y, z})), 0), 0 );

 while (floodfill_queue.length > 0) {
  QueueElement item = (&floodfill_queue)->data[--(&floodfill_queue)->length];
  ...
  for (int i = 0; i < 6; i++) {
   ...
   if (x < 0 || y < 0 || z < 0 || x >= (16) || y >= (16) || z >= (16)) {
    exitPoints[i] = 
# 187 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c" 3 4
                   1
# 187 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c"
                       ;
   } else {
...
void PolyGen_GeneratePolygons(WorkQueue* queue, WorkerItem item, void* this) {
 for (int i = 0; i < ((128) / (16)); i++) {
  ...
  if (cluster->revision != cluster->vboRevision || cluster->forceVBOUpdate) {
   ...
   cluster->forceVBOUpdate = 
# 218 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c" 3 4
                            0
# 218 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c"
                                 ;
   ...
   if (currentFace) {
    ...
    for (int j = 0; j < currentFace; j++) {
     ...
     int offsetX = face.x + item.chunk->x * (16);
     int offsetZ = face.z + item.chunk->z * (16);
     int offsetY = face.y + i * (16);
     ...
     for (int k = 0; k < 6; k++) {
      ...
      data[k].uv[0] = (data[k].uv[0] == 1 ? ((32768 / 8) - 1) : 1) + iconUV[0];
      data[k].uv[1] = (data[k].uv[1] == 1 ? ((32768 / 8) - 1) : 1) + iconUV[1];
   ...
   ( vec_expand_((char**)&(&vboUpdates)->data, &(&vboUpdates)->length, &(&vboUpdates)->capacity, sizeof(*(&vboUpdates)->data)) ? -1 : ((&vboUpdates)->data[(&vboUpdates)->length++] = (update), 0), 0 );
   LightLock_Unlock(&updateLock);
  }
 }
 item.chunk->displayRevision = item.chunk->revision;
 item.chunk->forceVBOUpdate = 
# 384 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c" 3 4
                             0
# 384 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/PolyGen.c"
                                  ;
}
