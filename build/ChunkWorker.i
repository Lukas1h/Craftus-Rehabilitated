# 0 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c"
# 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c"
...
# 4 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/world/ChunkWorker.h" 2
...
# 6 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/world/ChunkWorker.h" 2
...
# 2 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c" 2

# 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/misc/Crash.h" 1
       

void Crash(const char* reason, ...);
# 4 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c" 2
...
void ChunkWorker_Init(ChunkWorker* chunkworker) {
 ...
 for (int i = 0; i < WorkerItemTypes_Count; i++) memset((&chunkworker->handler[i]), 0, sizeof(*(&chunkworker->handler[i])));

 s32 prio;
 
# 17 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c" 3 4
_Bool 
# 17 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c"
     isNew3ds = 
# 17 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c" 3 4
                0
# 17 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c"
 ...
 chunkworker->thread =
     threadCreate(&ChunkWorker_Mainloop, (void*)chunkworker, (16 * 1024), prio - 1, isNew3ds ? 2 : 1, 
# 21 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c" 3 4
                                                                                                                      0
# 21 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c"
                                                                                                                           );
 ...
 chunkworker->working = 
# 26 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c" 3 4
                       0
# 26 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c"
                            ;
}

static volatile ChunkWorker* workerToStop = 
# 29 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c" 3 4
                                           ((void *)0)
# 29 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c"
                                               ;
void ChunkWorker_Deinit(ChunkWorker* chunkworker) {
 workerToStop = chunkworker;
 LightEvent_Signal(&chunkworker->queue.itemAddedEvent);
 threadJoin(chunkworker->thread, 
# 33 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c" 3 4
                                (0xffffffffffffffffULL)
# 33 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c"
                                          );
 ...
 for (int i = 0; i < WorkerItemTypes_Count; i++) {
  ( free((&chunkworker->handler[i])->data), memset((&chunkworker->handler[i]), 0, sizeof(*(&chunkworker->handler[i]))) );
 }
}
...
void ChunkWorker_AddHandler(ChunkWorker* chunkworker, WorkerItemType type, WorkerFuncObj obj) {
 ( vec_expand_((char**)&(&chunkworker->handler[type])->data, &(&chunkworker->handler[type])->length, &(&chunkworker->handler[type])->capacity, sizeof(*(&chunkworker->handler[type])->data)) ? -1 : ((&chunkworker->handler[type])->data[(&chunkworker->handler[type])->length++] = (obj), 0), 0 );
}

void ChunkWorker_SetHandlerActive(ChunkWorker* chunkworker, WorkerItemType type, void* this, 
# 52 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c" 3 4
                                                                                            _Bool 
# 52 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c"
                                                                                                 active) {
...
void ChunkWorker_Mainloop(void* _this) {
 struct { WorkerItem *data; int length, capacity; } privateQueue;
 memset((&privateQueue), 0, sizeof(*(&privateQueue)));
 ChunkWorker* chunkworker = (ChunkWorker*)_this;
 while (workerToStop != chunkworker || chunkworker->queue.queue.length > 0) {
  chunkworker->working = 
# 66 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c" 3 4
                        0
# 66 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c"
                             ;
  ...
  chunkworker->working = 
# 71 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c" 3 4
                        1
# 71 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c"
                            ;

  LightLock_Lock(&chunkworker->queue.listInUse);
  do { int i__, n__ = (chunkworker->queue.queue.length); if (vec_reserve_po2_((char**)&(&privateQueue)->data, &(&privateQueue)->length, &(&privateQueue)->capacity, sizeof(*(&privateQueue)->data), (&privateQueue)->length + n__) != 0) break; for (i__ = 0; i__ < n__; i__++) { (&privateQueue)->data[(&privateQueue)->length++] = (chunkworker->queue.queue.data)[i__]; } } while (0);
  ((&chunkworker->queue.queue)->length = 0);
  LightLock_Unlock(&chunkworker->queue.listInUse);

  while (privateQueue.length > 0) {
   WorkerItem item = (&privateQueue)->data[--(&privateQueue)->length];
 ...
 ( free((&privateQueue)->data), memset((&privateQueue), 0, sizeof(*(&privateQueue))) );
}
