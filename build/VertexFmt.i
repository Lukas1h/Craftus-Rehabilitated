# 0 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/VertexFmt.c"
# 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/VertexFmt.c"
...
# 4 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/rendering/VertexFmt.h" 2
...
# 5 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/misc/NumberUtils.h" 2
...
# 2 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/rendering/VertexFmt.c" 2
...
int16_t RGB16_ToHSV(uint16_t rgb) {
 ...
 if (delta == 0) {
  ...
  if (r == M)
   ...
   h = ((b - r) * 60 * 512) / delta + 120 * 512;
  else
   h = ((r - g) * 60 * 512) / delta + 240 * 512;
 ...
 return (((out_v & 0x1f)) | (((out_s)&0x1f) << 5) | (((out_h)&0x1f) << 10));
}

int16_t HSV16_ToRGB(int16_t hsv) {
 int16_t r, g, b;
 int16_t in_h = (((hsv) >> 10) & 0x1f), in_s = (((hsv) >> 5) & 0x1f), in_v = ((hsv)&0x1f);
 ...
 if (in_s == 0) {
  ...
  if (i & 1) {
   int q = (0x1f * 60 * 512 * v - h * s * v + 60 * 512 * s * v * i) / (0x1f * 60 * 512);
   switch (i) {
    case 1:
     r = q;
     g = v;
   ...
   int t = (0x1f * 60 * 512 * v + h * s * v - 60 * 512 * s * v * (i + 1)) / (0x1f * 60 * 512);
   switch (i) {
    case 0:
     r = v;
     g = t;
 ...
 return (((b & 0x1f)) | (((g)&0x1f) << 5) | (((r)&0x1f) << 10));
}
