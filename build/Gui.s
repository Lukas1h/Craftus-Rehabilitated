...
.Ltext0:
	...
	.file 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/gui/Gui.c"
...
.LVL22:
	...
	.loc 1 76 40 is_stmt 0 view .LVU133
	vcmp.f32	s16, #0
	vmrs	APSR_nzcv, FPSCR
	.loc 1 77 103 view .LVU134
	ldr	r3, [r5, #76]
	ldr	r2, [sp, #24]
	.loc 1 76 40 view .LVU135
	movls	r4, r0
.LVL23:
	.loc 1 77 103 view .LVU136
	cmp	r3, r2
	movlt	r3, r2
	.loc 1 76 48 view .LVU137
	ldr	ip, [r5, #48]
	.loc 1 76 12 view .LVU138
	ldr	r1, [r5, #56]
...
.LFB218:
	...
	.loc 1 115 41 is_stmt 0 view .LVU158
	ldr	r2, .L42
.LVL31:
.LBB32:
.LBI32:
...
.LBE33:
.LBE32:
	.loc 1 115 74 view .LVU164
	ldr	r0, [r2, #48]
	.loc 1 115 41 view .LVU165
	ldr	r1, [r2, #56]
...
.LVL34:
	...
	mov	r1, r0
	.loc 1 124 6 view .LVU196
	mov	r0, r4
	bl	__aeabi_idiv
.LVL35:
	.loc 1 125 23 view .LVU197
	ldrh	r9, [r9, #18]
	.loc 1 124 6 view .LVU198
	mov	r4, r0
.LVL36:
...
.LVL38:
	...
	mov	r3, r0
	.loc 1 126 42 view .LVU206
	cmp	r4, r5
	movlt	r0, #0
	andge	r0, ip, #1
.LVL39:
	.loc 1 126 42 view .LVU207
	cmp	r0, #0
	popeq	{r4, r5, r6, r7, r8, r9, r10, pc}
	.loc 1 126 77 discriminator 3 view .LVU208
	add	r5, r5, r7
.LVL40:
	.loc 1 126 81 discriminator 3 view .LVU209
	cmp	r3, r6
	cmpge	r5, r4
	movgt	r0, #1
	movle	r0, #0
...
.LVL41:
	...
	movle	r0, #0
	movgt	r0, #1
	.loc 1 127 1 discriminator 7 view .LVU212
...
.LVL48:
	...
	add	r5, r5, r7
.LVL49:
	.loc 1 131 93 discriminator 3 view .LVU235
	cmp	r3, r6
	cmpge	r5, r4
	movgt	r0, #1
	movle	r0, #0
	pople	{r4, r5, r6, r7, r8, r9, r10, pc}
	.loc 1 132 26 discriminator 7 view .LVU236
	add	r6, r6, r8
.LVL50:
	...
	movle	r0, #0
	movgt	r0, #1
	.loc 1 133 1 discriminator 7 view .LVU238
	pop	{r4, r5, r6, r7, r8, r9, r10, pc}
.L72:
	.align	2
.L71:
...
.LVL59:
	...
	mov	r10, #8
	mov	r3, #0
	.loc 1 97 62 is_stmt 0 view .LVU276
	add	r4, r4, r4, lsl #2
.LVL60:
...
.LVL61:
	.loc 1 98 2 is_stmt 1 view .LVU279
	sub	r3, r7, #16
	add	r0, r8, r10
	mvn	r2, #2
	mov	r1, fp
...
.LVL63:
	...
	strd	r2, [sp]
	ldr	r3, [sp, #44]
	.loc 1 103 51 is_stmt 0 view .LVU282
	add	r0, r6, r6, lsr #31
	.loc 1 103 2 view .LVU283
	str	r3, [sp, #16]
	.loc 1 103 51 view .LVU284
	asr	r0, r0, #1
	.loc 1 103 35 view .LVU285
	add	r3, r7, r7, lsr #31
	.loc 1 103 39 view .LVU286
	rsb	r0, r0, r3, asr #1
	...
	bl	SpriteBatch_PushTextVargs
.LVL64:
	.loc 1 105 1 is_stmt 1 view .LVU288
	.loc 1 107 2 view .LVU289
	.loc 1 108 96 is_stmt 0 view .LVU290
	ldr	r3, [r5, #76]
	.loc 1 107 12 view .LVU291
	ldr	r2, [r5, #56]
	.loc 1 108 96 view .LVU292
	cmp	r3, r9
	movlt	r3, r9
	.loc 1 108 28 view .LVU293
	str	r3, [r5, #76]
	.loc 1 107 17 view .LVU294
	ldr	r3, [r5, #48]
	.loc 1 110 19 view .LVU295
	ldr	r0, [r5, #8]
	...
	ands	r0, r0, #1048576
	.loc 1 107 12 view .LVU299
	str	r3, [r5, #56]
	.loc 1 108 2 is_stmt 1 view .LVU300
	.loc 1 110 2 view .LVU301
	.loc 1 110 5 is_stmt 0 view .LVU302
	bne	.L82
.L77:
...
.L82:
	.cfi_restore_state
	.loc 1 110 34 discriminator 1 view .LVU306
	mov	r3, r9
	mov	r2, r7
	mov	r1, fp
	mov	r0, r8
...
.LFB223:
	...
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 135 2 view .LVU308
	.loc 1 134 57 is_stmt 0 view .LVU309
	push	{r4, r5, r6, r7, r8, r9, r10, lr}
	.cfi_def_cfa_offset 32
	.cfi_offset 4, -32
	.cfi_offset 5, -28
	...
	.cfi_offset 10, -8
	.cfi_offset 14, -4
	.loc 1 135 29 view .LVU310
	ldr	r4, .L89
	.loc 1 134 57 view .LVU311
	mov	r7, r2
	mov	r8, r3
	.loc 1 135 29 view .LVU312
	ldrh	r9, [r4, #40]
	.loc 1 134 57 view .LVU313
	mov	r6, r1
	mov	r5, r0
	.loc 1 135 39 view .LVU314
	bl	SpriteBatch_GetScale
.LVL70:
	.loc 1 135 39 view .LVU315
	mov	r1, r0
	.loc 1 135 6 view .LVU316
	mov	r0, r9
	bl	__aeabi_idiv
.LVL71:
	.loc 1 136 29 view .LVU317
	ldrh	r9, [r4, #42]
	.loc 1 135 6 view .LVU318
	mov	r4, r0
.LVL72:
	.loc 1 136 2 is_stmt 1 view .LVU319
	.loc 1 136 39 is_stmt 0 view .LVU320
	bl	SpriteBatch_GetScale
.LVL73:
	.loc 1 136 39 view .LVU321
	mov	r1, r0
.LVL74:
	.loc 1 138 2 is_stmt 1 view .LVU322
	.loc 1 136 6 is_stmt 0 view .LVU323
	mov	r0, r9
.LVL75:
	.loc 1 136 6 view .LVU324
	bl	__aeabi_idiv
.LVL76:
	.loc 1 138 50 view .LVU325
	orrs	r0, r0, r4
	beq	.L88
	.loc 1 139 1 discriminator 6 view .LVU326
	mov	r0, #0
	pop	{r4, r5, r6, r7, r8, r9, r10, pc}
.L88:
	.loc 1 138 53 discriminator 1 view .LVU327
	mov	r3, r8
	mov	r2, r7
	mov	r1, r6
	mov	r0, r5
	.loc 1 139 1 discriminator 1 view .LVU328
	...
	.cfi_def_cfa_offset 0
.LVL77:
	.loc 1 138 53 discriminator 1 view .LVU329
	b	Gui_IsCursorInside
.LVL78:
.L90:
	.loc 1 138 53 discriminator 1 view .LVU330
	.align	2
.L89:
	.word	.LANCHOR0
	.cfi_endproc
...
.LFB224:
	...
	.loc 1 140 44 is_stmt 0 view .LVU333
	...
	.cfi_offset 8, -8
	.cfi_offset 14, -4
	.loc 1 141 25 view .LVU334
	ldr	r6, .L99
	.loc 1 140 44 view .LVU335
	mov	r5, r0
	.loc 1 141 5 view .LVU336
	ldr	r3, [r6, #16]
	.loc 1 140 44 view .LVU337
	mov	r4, r1
	.loc 1 141 5 view .LVU338
	cmp	r3, #0
	beq	.L92
	.loc 1 141 47 discriminator 1 view .LVU339
	ldr	r3, [r6, #40]
	cmp	r3, #0
	bne	.L93
.L92:
	.loc 1 142 3 is_stmt 1 view .LVU340
	.loc 1 142 6 is_stmt 0 view .LVU341
	mov	r2, #0
	.loc 1 144 3 view .LVU342
	mov	r3, r2
	.loc 1 142 6 view .LVU343
	str	r2, [r5]
	.loc 1 143 3 is_stmt 1 view .LVU344
	.loc 1 144 3 view .LVU345
	.loc 1 143 6 is_stmt 0 view .LVU346
	str	r3, [r4]
	.loc 1 148 1 view .LVU347
	pop	{r4, r5, r6, r7, r8, pc}
.L93:
	.loc 1 146 2 is_stmt 1 view .LVU348
	.loc 1 146 12 is_stmt 0 view .LVU349
	ldrh	r7, [r6, #16]
	.loc 1 146 22 view .LVU350
	bl	SpriteBatch_GetScale
.LVL80:
	.loc 1 146 22 view .LVU351
	mov	r1, r0
	.loc 1 146 20 view .LVU352
	mov	r0, r7
	bl	__aeabi_idiv
.LVL81:
	.loc 1 146 55 view .LVU353
	ldrh	r8, [r6, #40]
	.loc 1 146 20 view .LVU354
	mov	r7, r0
	.loc 1 146 65 view .LVU355
	bl	SpriteBatch_GetScale
.LVL82:
	mov	r1, r0
	.loc 1 146 63 view .LVU356
	mov	r0, r8
	bl	__aeabi_idiv
.LVL83:
	.loc 1 146 45 view .LVU357
	sub	r7, r7, r0
	.loc 1 147 12 view .LVU358
	ldrh	r8, [r6, #18]
	.loc 1 146 5 view .LVU359
	str	r7, [r5]
	.loc 1 147 2 is_stmt 1 view .LVU360
	.loc 1 147 22 is_stmt 0 view .LVU361
	bl	SpriteBatch_GetScale
.LVL84:
	mov	r1, r0
	.loc 1 147 20 view .LVU362
	mov	r0, r8
	bl	__aeabi_idiv
.LVL85:
	.loc 1 147 55 view .LVU363
	ldrh	r6, [r6, #42]
	.loc 1 147 20 view .LVU364
	mov	r5, r0
.LVL86:
	.loc 1 147 65 view .LVU365
	bl	SpriteBatch_GetScale
.LVL87:
	mov	r1, r0
	.loc 1 147 63 view .LVU366
	mov	r0, r6
	bl	__aeabi_idiv
.LVL88:
	.loc 1 147 45 view .LVU367
	sub	r3, r5, r0
	.loc 1 143 6 view .LVU368
	str	r3, [r4]
	.loc 1 148 1 view .LVU369
	pop	{r4, r5, r6, r7, r8, pc}
.L100:
	.align	2
.L99:
...
.Letext0:
	...
	.file 4 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/misc/InputData.h"
	.file 5 "/opt/devkitpro/devkitARM/lib/gcc/arm-none-eabi/12.2.0/include/stdarg.h"
	...
	.file 14 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/gui/SpriteBatch.h"
