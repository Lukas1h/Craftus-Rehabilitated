...
.Ltext0:
	...
	.file 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/world/ChunkWorker.c"
...
.LVL5:
	...
	bl	vec_reserve_po2_
.LVL6:
	.loc 1 74 61 view .LVU27
	subs	r3, r0, #0
	beq	.L3
.LVL7:
.L6:
	.loc 1 74 61 view .LVU28
.LBE8:
	.loc 1 74 6 is_stmt 1 view .LVU29
...
.LVL13:
.LBB6:
	.loc 1 82 23 is_stmt 1 view .LVU52
	.loc 1 82 56 is_stmt 0 view .LVU53
	add	r7, r8, r8, lsl #1
	add	r7, r9, r7, lsl #2
	.loc 1 82 23 view .LVU54
	ldr	r3, [r7, #32]
	cmp	r3, #0
...
.L9:
	...
	.loc 1 82 66 view .LVU61
	add	r4, r4, #1
.LVL15:
	.loc 1 83 9 view .LVU62
	cmp	r0, #0
	beq	.L13
	.loc 1 84 7 view .LVU63
	ldr	r1, [r1, #4]
	ldr	r0, [sp, #12]
	.loc 1 84 46 view .LVU64
	ldr	r9, [r3, r2, lsl #2]
	.loc 1 84 7 view .LVU65
	str	r0, [sp, #44]
	strb	r8, [sp, #36]
	str	r5, [sp, #40]
	str	r1, [sp]
...
.LVL16:
.L13:
	.loc 1 86 6 is_stmt 1 discriminator 2 view .LVU66
	mov	r0, r10
	mov	r1, fp
	bl	svcSleepThread
.LVL17:
	.loc 1 82 66 discriminator 2 view .LVU67
	.loc 1 82 23 discriminator 2 view .LVU68
	ldr	r3, [r7, #32]
	cmp	r3, r4
	bgt	.L9
	ldr	r9, [sp, #20]
.LVL18:
.L14:
	.loc 1 82 23 is_stmt 0 discriminator 2 view .LVU69
.LBE6:
...
.LBE11:
.LBB12:
	.loc 1 74 259 is_stmt 1 view .LVU101
	cmp	r5, #0
	ble	.L6
	.loc 1 74 312 is_stmt 0 view .LVU102
	ldr	r2, [sp, #28]
	ldr	r6, [sp, #24]
	add	lr, r2, #1
	.loc 1 74 351 view .LVU103
	ldr	r7, [r9, #4]
	add	r2, r2, r2, lsl #1
	add	r5, lr, r5
.LVL24:
	.loc 1 74 351 view .LVU104
	add	r6, r6, r2, lsl #2
.LVL25:
.L7:
	...
	add	ip, r6, r3
	add	r2, r7, r3
	.loc 1 74 259 discriminator 5 view .LVU109
	cmp	r5, lr
...
.LVL26:
	.loc 1 74 259 discriminator 5 view .LVU112
	.loc 1 74 324 is_stmt 0 discriminator 5 view .LVU113
	stm	ip, {r0, r1, r2}
	.loc 1 74 259 discriminator 5 view .LVU114
	bne	.L7
	b	.L6
.L30:
	.align	2
...
.LFB117:
	...
	.loc 1 7 49 is_stmt 0 view .LVU117
	push	{r4, r5, lr}
...
.LBB16:
.LBB17:
	.file 2 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/world/WorkQueue.h"
	.loc 2 36 2 view .LVU118
	mov	r3, #0
.LBE17:
.LBE16:
	.loc 1 7 49 view .LVU119
	mov	r5, r0
.LVL28:
.LBB20:
.LBI16:
	.loc 2 35 13 is_stmt 1 view .LVU120
.LBB18:
	.loc 2 36 2 view .LVU121
.LBE18:
.LBE20:
...
.LBB21:
.LBB19:
	.loc 2 36 2 view .LVU123
	str	r3, [r5, #4]	@ unaligned
	str	r3, [r5, #8]	@ unaligned
	str	r3, [r5, #12]	@ unaligned
	.loc 2 37 2 is_stmt 1 view .LVU124
	add	r0, r0, #24
.LVL29:
	.loc 2 37 2 is_stmt 0 view .LVU125
	bl	LightLock_Init
.LVL30:
	.loc 2 38 2 is_stmt 1 view .LVU126
	mov	r1, #1
	add	r0, r5, #16
	bl	LightEvent_Init
.LVL31:
	.loc 2 38 2 is_stmt 0 view .LVU127
.LBE19:
.LBE21:
	.loc 1 10 2 is_stmt 1 view .LVU128
	.loc 1 10 8 is_stmt 0 view .LVU129
	mov	r0, #30
	bl	APT_SetAppCpuTimeLimit
.LVL32:
	.loc 1 10 5 view .LVU130
	cmp	r0, #0
	blt	.L37
.L32:
.LBB22:
	.loc 1 14 50 view .LVU131
	mov	r4, #0
	add	r3, r5, #28
	add	r2, r5, #88
.L33:
	.loc 1 14 50 is_stmt 1 discriminator 3 view .LVU132
	str	r4, [r3]	@ unaligned
	str	r4, [r3, #4]	@ unaligned
	str	r4, [r3, #8]	@ unaligned
	.loc 1 14 46 discriminator 3 view .LVU133
	.loc 1 14 20 discriminator 3 view .LVU134
	add	r3, r3, #12
	cmp	r3, r2
	bne	.L33
.LBE22:
	.loc 1 16 2 view .LVU135
	.loc 1 17 1 view .LVU136
	.loc 1 18 2 is_stmt 0 view .LVU137
	add	r0, sp, #11
	.loc 1 17 6 view .LVU138
	strb	r4, [sp, #11]
	.loc 1 18 2 is_stmt 1 view .LVU139
	bl	APT_CheckNew3DS
.LVL33:
	.loc 1 19 2 view .LVU140
	ldr	r1, .L39
	add	r0, sp, #12
	bl	svcGetThreadPriority
.LVL34:
	.loc 1 20 2 view .LVU141
	.loc 1 21 6 is_stmt 0 view .LVU142
	ldrb	r1, [sp, #11]	@ zero_extendqisi2
	.loc 1 21 80 view .LVU143
	ldr	r3, [sp, #12]
	.loc 1 21 6 view .LVU144
	add	r1, r1, #1
	stm	sp, {r1, r4}
	mov	r2, #16384
	mov	r1, r5
	...
	bl	threadCreate
.LVL35:
	.loc 1 22 5 view .LVU145
	cmp	r0, #0
	.loc 1 20 22 view .LVU146
	str	r0, [r5]
	.loc 1 22 2 is_stmt 1 view .LVU147
	.loc 1 22 5 is_stmt 0 view .LVU148
	beq	.L38
	.loc 1 26 2 is_stmt 1 view .LVU149
	.loc 1 26 23 is_stmt 0 view .LVU150
	mov	r3, #0
	strb	r3, [r5, #88]
	.loc 1 27 1 view .LVU151
	add	sp, sp, #20
	.cfi_remember_state
	.cfi_def_cfa_offset 12
	@ sp needed
...
.L37:
	.cfi_restore_state
	.loc 1 11 3 is_stmt 1 view .LVU152
	ldr	r0, .L39+8
	bl	Crash
.LVL37:
.LBB23:
	.loc 1 14 20 view .LVU153
	b	.L32
.LVL38:
.L38:
	.loc 1 14 20 is_stmt 0 view .LVU154
.LBE23:
	.loc 1 23 3 is_stmt 1 view .LVU155
	ldr	r0, .L39+12
	bl	Crash
.LVL39:
	.loc 1 26 2 view .LVU156
	.loc 1 26 23 is_stmt 0 view .LVU157
	mov	r3, #0
	strb	r3, [r5, #88]
...
.LFB118:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	.loc 1 31 2 view .LVU161
	.loc 1 30 51 is_stmt 0 view .LVU162
	...
	.cfi_offset 8, -8
	.cfi_offset 14, -4
	.loc 1 30 51 view .LVU163
	mov	r7, r0
.LBB27:
.LBB28:
	.loc 2 40 52 view .LVU164
	mov	r6, r7
	.loc 2 40 81 view .LVU165
	mov	r5, #0
.LBE28:
.LBE27:
	.loc 1 31 15 view .LVU166
	ldr	r3, .L46
	.loc 1 32 2 view .LVU167
	add	r0, r0, #16
.LVL42:
	.loc 1 31 15 view .LVU168
	str	r7, [r3]
	.loc 1 32 2 is_stmt 1 view .LVU169
	bl	LightEvent_Signal
.LVL43:
	.loc 1 33 2 view .LVU170
	mvn	r2, #0
	mvn	r3, #0
	ldr	r0, [r7]
	bl	threadJoin
.LVL44:
	.loc 1 35 2 view .LVU171
	ldr	r0, [r7]
	bl	threadFree
.LVL45:
	.loc 1 36 2 view .LVU172
.LBB30:
.LBI27:
	.loc 2 40 13 view .LVU173
.LBB29:
	.loc 2 40 50 view .LVU174
	.loc 2 40 52 is_stmt 0 view .LVU175
	ldr	r0, [r6, #4]!
.LVL46:
	.loc 2 40 52 view .LVU176
	bl	free
.LVL47:
	add	r4, r7, #28
	.loc 2 40 81 view .LVU177
	str	r5, [r7, #4]	@ unaligned
	add	r8, r7, #88
	str	r5, [r6, #4]	@ unaligned
	str	r5, [r6, #8]	@ unaligned
.LVL48:
	.loc 2 40 81 view .LVU178
.LBE29:
.LBE30:
.LBB31:
	.loc 1 38 20 is_stmt 1 view .LVU179
.L42:
	.loc 1 39 3 discriminator 3 view .LVU180
	.loc 1 39 5 is_stmt 0 discriminator 3 view .LVU181
	ldr	r0, [r4]
	.loc 1 38 20 discriminator 3 view .LVU182
	add	r4, r4, #12
	.loc 1 39 5 discriminator 3 view .LVU183
	bl	free
.LVL49:
	.loc 1 38 20 discriminator 3 view .LVU184
	cmp	r4, r8
	.loc 1 39 45 discriminator 3 view .LVU185
	str	r5, [r4, #-12]	@ unaligned
	str	r5, [r4, #-8]	@ unaligned
	str	r5, [r4, #-4]	@ unaligned
	.loc 1 38 46 is_stmt 1 discriminator 3 view .LVU186
	.loc 1 38 20 discriminator 3 view .LVU187
	bne	.L42
...
.LFB119:
	...
	add	r0, r0, #16
.LVL51:
	.loc 1 45 70 view .LVU193
	mov	r7, #0
	ldr	r6, .L53
	.loc 1 44 2 view .LVU194
	bl	LightEvent_Signal
.LVL52:
	.loc 1 45 2 is_stmt 1 view .LVU195
.L49:
	.loc 1 45 70 discriminator 1 view .LVU196
...
.LBB32:
	...
	.loc 1 53 23 view .LVU222
	.loc 1 53 51 is_stmt 0 view .LVU223
	add	r1, r1, r1, lsl #1
.LVL60:
	.loc 1 53 51 view .LVU224
	add	r0, r0, r1, lsl #2
.LVL61:
	.loc 1 53 51 view .LVU225
.LBE32:
	...
	.cfi_offset 14, -4
.LBB33:
	.loc 1 53 51 view .LVU227
	ldr	lr, [r0, #32]
	.loc 1 53 23 view .LVU228
	cmp	lr, #0
	ldreq	pc, [sp], #4
...
.LVL62:
.L60:
	.loc 1 53 23 discriminator 2 view .LVU230
	cmp	ip, lr
	add	r1, r1, #12
	ldreq	pc, [sp], #4
.LVL63:
.L61:
	...
	.loc 1 53 61 view .LVU232
	.loc 1 54 6 is_stmt 0 view .LVU233
	ldr	r0, [r1, #4]
	.loc 1 53 61 view .LVU234
	add	ip, ip, #1
.LVL64:
	.loc 1 53 23 is_stmt 1 view .LVU235
...
.Letext0:
	...
	.file 16 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/blocks/Block.h"
	.file 17 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/rendering/VBOCache.h"
	.file 18 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/world/Chunk.h"
	.file 19 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/world/ChunkWorker.h"
	.file 20 "/Users/blackout/Desktop/Craftus-Rehabilitated/dependencies/vec/vec.h"
	...
	.file 24 "/Users/blackout/Desktop/Craftus-Rehabilitated/include/misc/Crash.h"
...
.LASF176:
	...
	.ascii	"e/world/ChunkWorker.c\000"
.LASF96:
