...
.Ltext0:
	...
	.file 1 "/Users/blackout/Desktop/Craftus-Rehabilitated/source/blocks/BlockEvent.c"
...
.LBE63:
.LBE62:
	.loc 1 6 21 is_stmt 1 view .LVU11
	ldr	r3, [sp, #16]
	sub	r10, r6, #12
	add	r2, r3, r7, lsl #2
	ldr	r3, [sp, #64]
...
.LBB173:
	...
	.loc 1 8 8 is_stmt 0 view .LVU13
	ldr	r3, [sp, #4]
	.loc 1 8 14 view .LVU14
	ldr	r0, [fp], #4
...
.LBE97:
.LBE112:
	.loc 1 24 10 view .LVU60
	ldrb	r0, [r0, #28]	@ zero_extendqisi2
	and	r1, r1, #15
	bl	Block_Opaque
.LVL13:
	.loc 1 24 9 view .LVU61
	cmp	r0, #0
	bne	.L29
.L3:
	.loc 1 36 4 is_stmt 1 discriminator 2 view .LVU62
.LVL14:
	.loc 1 36 4 is_stmt 0 discriminator 2 view .LVU63
.LBE173:
	.loc 1 6 29 is_stmt 1 discriminator 2 view .LVU64
	.loc 1 6 21 discriminator 2 view .LVU65
	ldr	r3, [sp]
	cmp	r3, r10
	bne	.L11
.L30:
.LBB174:
	.loc 1 36 5 is_stmt 0 discriminator 2 view .LVU66
	ldr	r7, [sp, #12]
	ldr	ip, [sp, #4]
	add	r7, r7, #3
.LBE174:
...
.LVL15:
	.loc 1 5 20 discriminator 2 view .LVU68
	cmp	r7, #24
	add	r6, r3, #12
	add	ip, ip, #16
	bne	.L2
...
.LBE175:
	.loc 1 6 29 is_stmt 1 view .LVU103
	.loc 1 6 21 view .LVU104
	ldr	r3, [sp]
	cmp	r3, r10
	bne	.L11
	b	.L30
...
.LBE124:
.LBE139:
	.loc 1 29 10 view .LVU129
	ldrb	r0, [r0, #28]	@ zero_extendqisi2
	and	r1, r1, #15
	bl	Block_Opaque
.LVL26:
	.loc 1 29 9 view .LVU130
	cmp	r0, #0
	beq	.L3
...
.LBE147:
.LBE162:
	.loc 1 13 11 view .LVU163
	ldrb	r0, [r0, #28]	@ zero_extendqisi2
	and	r1, r1, #15
	bl	Block_Opaque
.LVL34:
	.loc 1 13 9 view .LVU164
	cmp	r0, #0
	bne	.L3
...
.LLRL5:
	...
	.uleb128 .LBE60-.LBB60
	.byte	0x4
	.uleb128 .LBB178-.LBB60
	.uleb128 .LBE178-.LBB60
	.byte	0x4
...
.LLRL7:
	...
	.uleb128 .LBE61-.LBB61
	.byte	0x4
	.uleb128 .LBB177-.LBB61
	.uleb128 .LBE177-.LBB61
	.byte	0
.LLRL9:
	.byte	0x5
	.4byte	.LBB62
	...
	.uleb128 .LBE62-.LBB62
	.byte	0x4
	.uleb128 .LBB173-.LBB62
	.uleb128 .LBE173-.LBB62
	.byte	0x4
	.uleb128 .LBB174-.LBB62
	.uleb128 .LBE174-.LBB62
	.byte	0x4
...
.LASF134:
	...
	.ascii	"e/blocks/BlockEvent.c\000"
.LASF84:
	.ascii	"LightLock\000"
.LASF120:
	.ascii	"workqueue\000"
